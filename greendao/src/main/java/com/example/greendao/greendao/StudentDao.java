...
public class StudentDao extends AbstractDao<Student, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Name = new Property(1, String.class, "name", false, "studentName");
        public final static Property Gender = new Property(2, String.class, "gender", false, "GENDER");
        public final static Property Age = new Property(3, short.class, "age", false, "AGE");
    ...
    private Query<Student> course_StudentsQuery;
    ...
    public void readEntity(Cursor cursor, Student entity, int offset) {
        ...
        entity.setAge(cursor.getShort(offset + 3));
        entity.setAddress(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
        entity.setData(cursor.isNull(offset + 5) ? null : new java.util.Date(cursor.getLong(offset + 5)));
        entity.setCid(cursor.isNull(offset + 6) ? null : cursor.getLong(offset + 6));
     }
    ...
    public List<Student> _queryCourse_Students(Long cid) {
        synchronized (this) {
        ...
        Query<Student> query = course_StudentsQuery.forCurrentThread();
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN course T0 ON T.\"CID\"=T0.\"_id\"");
            builder.append(' ');
